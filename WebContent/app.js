...
//alert('in controller');
  ...
  $http({
  method:'POST',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//login',
  data:login,
...
var signup={
  ...
  $http({
  method:'POST',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//registerEmployee',
  data:signup,
  header:{'Content-Type':'application/json'}
  }).success(function (data, status, headers, config) {
...
//alert('in showemployee controller !!! READY TO fetch');
  ...
  $http({
  method:'GET',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//employees',
...
$http({
  method:'DELETE',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//delete/'+id
...
$http({
  method:'GET',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//getEmployeeInfo/'+uid
...
var employeeupdatedata={
  ...
  $http({
  method:'POST',
  url:'http://employeeportal-empp.44fs.preview.openshiftapps.com//updateEmployee',
